...
def main_4():
    sleep(2)
    print ("")
    slowprint("\033[1;33mNote : Dunia itu seperti roda")
    slowprint("kita tidak akan selamanya dibawah, akan")
    slowprint("ada saatnya kita diatas, yg penting kita")
    slowprint("selalu berusaha")
    sleep(3)
    ...
    pr = input("\033[1;33m[\033[1;37m?\033[1;33m] Password : \033[1;37m")
    try:
        sleep(2)
...
def main_2():
    ...
    print ("")
    slowprint("\033[1;32m[\033[33m*\033[1;32m] Menu : ")
