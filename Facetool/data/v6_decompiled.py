#Decompiled At:Thu Mar 12 23:58:40 2020 
...
def lisensi():
    ...
    print '\x1b[1;91mBelum punya lisensi ?\n082211661007'
    user = raw_input('\n\x1b[1;91m[?] \x1b[1;92mMasukan Lisensi\x1b[1;91m : \x1b[1;97m')
    r = requests.get('https://pastebin.com/raw/nUehjBdm').text
    if user == '':
